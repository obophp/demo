...
class UserProperties extends \Base\EntityProperties {
    ...
    /**
     * @obo-one(targetEntity = "User-Contact", autoCreate = true, eager = true, cascade = "save, delete")
     */
    public $contact = null;
    ...
    /**
     * @obo-many(targetEntity = "Tag", connectViaRepository="relationship_between_user_and_tag", sortVia = "{name}")
     */
    public $tags = null;

    /**
     * @obo-many(targetEntity = "Notice", connectViaProperty = "owner", ownerNameInProperty = "ownerEntityName", cascade = "save, delete")
     */
    public $notices = null;
