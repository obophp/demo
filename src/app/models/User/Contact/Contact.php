...
class ContactProperties extends \Base\EntityProperties {
    ...
    /**
     * @obo-one(targetEntity = "User", connectViaProperty="contact")
     */
    public $user = null;

    /**
     * @obo-one(targetEntity = "User-Contact-Address", autoCreate = true, eager = true, cascade = "save, delete")
     */
    public $address = null;
    ...
    /**
     * @obo-one(targetEntity = "Notice", connectViaProperty="owner", ownerNameInProperty = "ownerEntityName", autoCreate = true, eager = true, cascade = "save, delete")
     */
    public $notice = null;
 ...
 * @obo-name(User-Contact)
 * @property \Models\User $user
 * @property \Models\User\Contact\Address $address
 * @property string $email
 * @property string $phone
 * @property \Models\Notices\Notice $notice
 */
